...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "blank": MessageLookupByLibrary.simpleMessage(
      "Դատարկ դաշտը թույլատրելի չէ։",
    ),
    "cancel": MessageLookupByLibrary.simpleMessage("Cancel"),
    "email": MessageLookupByLibrary.simpleMessage("Email"),
    "favorite": MessageLookupByLibrary.simpleMessage("Նախընտրելի"),
    "forgot_password": MessageLookupByLibrary.simpleMessage("Forgot password?"),
    "log_out": MessageLookupByLibrary.simpleMessage("Ելք"),
    "login": MessageLookupByLibrary.simpleMessage("Login"),
    "no_user": MessageLookupByLibrary.simpleMessage(
      "Անվան օգտագործողը և գաղտնաբառը չեն համապատասխանում։",
    ),
    "password": MessageLookupByLibrary.simpleMessage("Password"),
    "sign_up": MessageLookupByLibrary.simpleMessage("Sign-up"),
    "support": MessageLookupByLibrary.simpleMessage("Աջակցում"),
